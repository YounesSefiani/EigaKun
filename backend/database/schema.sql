...
INSERT INTO seasons (serie_id, season_number, poster, first_episode_date, last_episode_date, synopsis, episodes)
VALUES ("1", "2", "https://image.tmdb.org/t/p/original/pw2rInLw1JH6hMxumFTCbqBbYfc.jpg", "2016-03-18", "2016-03-18", "Hell's Kitchen a un gardien qui veille la nuit : Daredevil. Le diable de Hell's Kitchen fera face à une menace plus grande que Wilson Fisk. Il doit confronter un vengeur sanguinaire, une ancienne connaissance et une organisation plus sombre et dangereuse.", "13");

INSERT INTO seasons (serie_id, season_number, poster, first_episode_date, last_episode_date, synopsis, episodes)
VALUES ("1", "3", "https://image.tmdb.org/t/p/original/9pY9oNwaz58Iw5NmnVnAEicV5oc.jpg", "2018-10-19", "2018-10-19", "Daredevil a survécu à la guerre contre la Main et à l'effondrement de la tour. Cependant, il est diminué sur le plan physique et mental. Alors qu'il essaie de se reconstruire, Wilson Fisk est de retour avec un plan de le détruire une bonne fois pour toutes.", "13");
